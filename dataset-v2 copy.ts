...
export class DataSetV2 {
  ...
  constructor(
    ...
    // Good mais on stock tout le data set sous forme de tensor en mémoire.
    // Ok pour quelques MO mais apres ca fait une quantité immense rapide.
    // En v3 on va faire un data loader qui charge les données en mémoire à la volée.
